          ...
          <div className="space-y-1.5">
            <div className="flex gap-2">
              <input 
                ...
                placeholder="/images/shoe-cutting-volunteers.webp"
...
export default function App() {
  ...
  const [imageMain, setImageMain] = useState(() => {
    return localStorage.getItem("party_image_main") || "/images/shoe-cutting-volunteers.webp";
  });
  const [imageSub1, setImageSub1] = useState(() => {
    return localStorage.getItem("party_image_sub1") || "/images/problem_reinfestation_feet_1783107783503.jpg";
  });
  const [imageSub2, setImageSub2] = useState(() => {
    return localStorage.getItem("party_image_sub2") || "/images/children-with-shoes.webp";
  });
          ...
          >
            ...
            <div className="absolute inset-0 z-0">
              <img 
                ...
                src="/images/children-shoes-lineup.jpg" 
