...
export default function App() {
  ...
  const [imageMain, setImageMain] = useState(() => {
    return localStorage.getItem("party_image_main") || "/images/shoe-party-group.jpg";
  });
  const [imageSub1, setImageSub1] = useState(() => {
    return localStorage.getItem("party_image_sub1") || "/images/church-volunteering.jpg";
  });
  const [imageSub2, setImageSub2] = useState(() => {
    return localStorage.getItem("party_image_sub2") || "/images/corporate-volunteering.jpg";
  });
          ...
          >
            ...
            <div className="absolute inset-0 z-0">
              <img 
                ...
                src="/images/hero-shoe-party.jpg" 
          ...
          <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-6 max-w-6xl mx-auto">
              ...
              >
                ...
                <div className="w-full aspect-[21/9] sm:aspect-[16/7] overflow-hidden relative bg-deep-ocean/5 shrink-0">
                  <img 
                    src="/images/family-volunteering.jpg" 
