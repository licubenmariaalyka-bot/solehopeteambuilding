...
export default function App() {
  ...
  const [imageMain, setImageMain] = useState(() => {
    return localStorage.getItem("party_image_main") || "https://lh3.googleusercontent.com/aida-public/AB6AXuCvAWRs8w19jy4SFn9JGYeIsuZcpRQ9URyzEiw2PI_BdkZHaY6bvdDIAxw3NNVXaGlsyWhlvpEL-J5U4NU2iyMjSZQnCmbMipK5ZGZ9MGKzE1oYtWrwAdgrdScOLzz79nS_Yg9p4-8q4aysKeg6ZeRXIgR_82nIZeVH8teVHKadaJXxJmpgc0CFB5rK0UPzEi6jNkeu5tcaM1B14MqdFrBb8bCSO6uaVWh_CazyBm-uNa0SdVkgF1zyPxizJEK0G9jrm9NQKYTyAy40Hw";
  });
  const [imageSub1, setImageSub1] = useState(() => {
    return localStorage.getItem("party_image_sub1") || "https://lh3.googleusercontent.com/aida-public/AB6AXuBvfM0Q4cEDKt3tMPCmNnDVNvodN-JBm_QA_DUeg2ciYy-y9sP0XKuUzY-RltVxX_RKD5NEtSOslGQKlAF6I5IPHO4RErlBkmmGCYDrAXuDpdpYTfrwzc_kebAdguqH-tzusnsUJFGUN7Ysz_GPRKkZMywZ3Yg4ij2nqEo-z9K3DSQsFDyxRi_Qce3QDSzLTOvSmejZ0z_mSbJaKm3DgycarO1jxtOceUArm5Gm-57OZxLHAOBZxWNBXnnFMo23ITJcShBxlPRYoLFq3A";
  });
  const [imageSub2, setImageSub2] = useState(() => {
    return localStorage.getItem("party_image_sub2") || "https://lh3.googleusercontent.com/aida-public/AB6AXuBr7XNWDv7j5uwTlGCaoEc3bqYlESEXcVKeMMORZND3BjCkD-fWYQneIKz7_iy8WhUAdYI2cBwqyKNC2c2bgYCj3vuwME1BXe6TTDEsAdt5fy6aZ1hOvZ754AuSPerTeS2wAudQS7RvUxXhgk7ccZJa-dMjyuqn8u7clAyOn9LeMO7LHO7dFZMp21QLjzre9lz940tOALMKtAucB0BGgrPZdnLPlxWnvOQuVRdEHH8Ba-e8CI4-nRWFA4cjTaLAZTBhcyLNfsOD5oNBvg";
  });
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Your purchase gives you access to the digital hosting materials and includes 2 pairs of protective shoes. Additional pairs can be completed for $35 each. Your support also helps Sole Hope continue treatment, education, outreach, and prevention work for children affected by jiggers in Uganda."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-parchment text-deep-ocean font-sans relative selection:bg-clay/20 selection:text-primary">
      ...
      <section id="experience-section" className="relative py-3 md:py-4 bg-parchment overflow-hidden min-h-[calc(100vh-80px)] flex flex-col justify-center">
          ...
          >
            ...
            <div className="absolute inset-0 z-0">
              <img 
                ...
                src="/images/regenerated_image_1783021426588.jpg" 
          ...
          <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-6 max-w-6xl mx-auto">
              ...
              >
                ...
                <div className="w-full aspect-[21/9] sm:aspect-[16/7] overflow-hidden relative bg-deep-ocean/5 shrink-0">
                  <img 
                    src="/images/family_volunteering_1782505486984.jpg" 
      ...
      <Footer 
        onNavigate={(view, section) => handleSubpageNavigation(view, section)} 
        onOpenContact={handleOpenContact} 
      />
          </motion.div>
        )}
