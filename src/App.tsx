...
export default function App() {
  ...
  const [imageMain, setImageMain] = useState(() => {
    return localStorage.getItem("party_image_main") || "/images/hero_children_shoes.jpg";
  });
  const [imageSub1, setImageSub1] = useState(() => {
    return localStorage.getItem("party_image_sub1") || "/images/holistic_care_medical_1783126149423.jpg";
  });
  const [imageSub2, setImageSub2] = useState(() => {
    return localStorage.getItem("party_image_sub2") || "/images/solution_protective_shoes_1783107803010.jpg";
  });
  ...
  return (
    <div className="min-h-screen bg-parchment text-deep-ocean font-sans relative selection:bg-clay/20 selection:text-primary">
          ...
          >
            ...
            <div className="absolute inset-0 z-0">
              <img 
                ...
                src="/images/hero_children_shoes.jpg" 
      ...
      {/* Anchor for "How It Works" back-navigation from sub-pages */}
