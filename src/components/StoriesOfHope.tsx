            ...
            <div className="relative order-2 md:order-1">
              <div className="overflow-hidden bg-white shadow-xl rounded-2xl rotate-[-1deg] p-4 border border-deep-ocean/5">
                <img 
                  ...
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuAGMDAb02r1IpDbdBcYAZm--n0zYg4ZVISi1f_KWd_y5idPceNdsg1N6cLcWGHUV1G8IUlXYLMIasChqUmgXTu7ikoivq8BtP1_hTyEfbB4iBuKiPr_DhwccCn-bSsoPaqYD9I9ryr6kzhvxvn-NB7bZUbFBISeGHGLjm3jTkbXDd8OKoin7J4WW3K5TMugK2-d2r4JUqjE92BwuR3L-G_d60rZJW5TBO9t9Ql7AhcYhGar_jBUP245bQbk3EM7mUyKuo37VaTsbDPr_g"
                />
              </div>
        ...
        <section className="py-28 px-6 text-center bg-parchment relative overflow-hidden">
          <div className="max-w-2xl mx-auto space-y-8 relative z-10">
            ...
            <p className="text-sm md:text-base text-on-surface-variant font-sans max-w-lg mx-auto leading-relaxed">
              Whether you're a family, church group, or company team, your action can create meaningful protection and hope. Join the global movement today.
            </p>
