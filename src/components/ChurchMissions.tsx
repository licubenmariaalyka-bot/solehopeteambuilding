...
export default function ChurchMissions({ onBack, onOpenVideo, onOpenBooking, onOpenContact }: ChurchMissionsProps) {
  ...
  return (
    <div className="min-h-screen bg-parchment text-ink font-sans selection:bg-clay/20 selection:text-clay">
      ...
      <main>
        {/* 1. HERO SECTION */}
        <section className="relative min-h-[580px] lg:min-h-[640px] flex items-center overflow-hidden bg-deep-ocean text-white">
          <div className="absolute inset-0 opacity-30">
            <img 
              className="w-full h-full object-cover" 
              alt="Warm Ugandan School Classroom"
              src="/src/assets/images/church-service-group.jpg"
            />
          </div>
          <div className="absolute inset-0 bg-gradient-to-r from-deep-ocean via-deep-ocean/85 to-transparent"></div>
          
          <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
            <motion.div 
              initial={{ opacity: 0, y: 15 }}
              animate={{ opacity: 1, y: 0 }}
              className="lg:col-span-8 space-y-6"
            >
              <span className="inline-block px-4 py-1.5 bg-clay/20 border border-clay/40 text-clay rounded-full text-xs font-mono font-bold uppercase tracking-widest">
                Church Mission Experience
              </span>
              <h1 className="font-serif text-3xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight text-white">
                Put Faith Into Action Through a Hands-On Mission Experience
              </h1>
              <p className="text-base md:text-lg text-white/90 max-w-2xl leading-relaxed font-sans font-medium">
              ...
              <p className="text-sm md:text-base text-parchment/90 font-sans italic border-l-2 border-clay pl-4">
                We’ll help guide your church to the right host resources, pricing, and next steps.
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <button 
                  onClick={scrollToForm}
                  className="bg-clay hover:brightness-110 text-white px-8 h-14 rounded-xl font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-2 hover:scale-102 transition-all shadow-lg shadow-clay/20 cursor-pointer"
                >
                  Plan a Church Shoe Cutting Party <ArrowRight className="w-4 h-4" />
                </button>
                <button 
                  onClick={() => scrollToSection("how-it-serves")}
                  className="border border-white/40 bg-white/10 text-white px-8 h-14 rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-white hover:text-deep-ocean transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                >
                  See How It Works
                </button>
              </div>
              
              <p className="text-[11px] text-white/70 font-mono tracking-wider italic pt-2">
                * Perfect for churches, youth groups, mission teams, women’s ministries, and outreach groups.
              </p>
            </motion.div>

            <div className="lg:col-span-4 hidden lg:block relative justify-self-center w-full max-w-sm">
              <div className="relative p-3 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl">
                <img 
                  className="rounded-xl shadow-xl w-full h-auto object-cover select-none" 
                  alt="Child Handmade Denim Shoes"
                  src="/src/assets/images/solution_protective_shoes_1783107803010.jpg"
                />
              </div>
            </div>
          </div>
        ...
        <section className="py-20 md:py-24 bg-white border-b border-deep-ocean/5">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
              ...
              <div className="w-12 h-0.5 bg-clay mx-auto mt-2" />
            </div>
            ...
            <div className="mt-12 text-center">
              ...
              >
                Plan a Church Party <ArrowRight className="w-4 h-4" />
              </button>
            </div>
          </div>
        </section>
        ...
        <section id="how-it-serves" className="py-20 md:py-24 bg-parchment">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {/* Step 1 */}
              <div className="relative group bg-white border border-deep-ocean/5 p-8 rounded-2xl hover:border-clay/20 transition-all shadow-sm flex flex-col h-full justify-between">
                <div className="space-y-4">
                  <div className="w-12 h-12 bg-deep-ocean text-white rounded-full flex items-center justify-center font-serif text-lg font-bold group-hover:bg-clay transition-colors">
                    1
                  </div>
                ...
                <div className="mt-6 pt-4 border-t border-deep-ocean/5">
                  <img 
                    className="w-full h-28 object-cover rounded-xl select-none" 
                    alt="Outreach Pack flat lay"
                    src="/src/assets/images/child-protection-impact.jpg"
                    referrerPolicy="no-referrer"
                  />
                </div>
              </div>
              ...
              <div className="relative group bg-white border border-deep-ocean/5 p-8 rounded-2xl hover:border-clay/20 transition-all shadow-sm flex flex-col h-full justify-between">
                ...
                <div className="mt-6 pt-4 border-t border-deep-ocean/5">
                  <img 
                    ...
                    src="/src/assets/images/shoemakers-at-work.jpg"
                    referrerPolicy="no-referrer"
                  />
                </div>
              </div>
              ...
              <div className="relative group bg-white border border-deep-ocean/5 p-8 rounded-2xl hover:border-clay/20 transition-all shadow-sm flex flex-col h-full justify-between">
                ...
                <div className="mt-6 pt-4 border-t border-deep-ocean/5">
                  <img 
                    ...
                    src="/src/assets/images/shoe_cutting_party_1782508448020.jpg"
                    referrerPolicy="no-referrer"
                  />
                </div>
              </div>
              ...
              <div className="relative group bg-white border border-deep-ocean/5 p-8 rounded-2xl hover:border-clay/20 transition-all shadow-sm flex flex-col h-full justify-between">
                ...
                <div className="mt-6 pt-4 border-t border-deep-ocean/5">
                  <img 
                    ...
                    src="/src/assets/images/children-with-shoes.webp"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 text-center">
              <button 
                ...
                className="bg-clay hover:brightness-110 text-white px-8 py-4 rounded-xl font-bold text-xs uppercase tracking-widest transition-all shadow-lg shadow-clay/15 hover:scale-102 active:scale-98 cursor-pointer inline-flex items-center gap-2"
              >
                Plan Your Party <ArrowRight className="w-4 h-4" />
              </button>
            </div>
          </div>
        </section>
        ...
        <section id="whats-included" className="py-20 md:py-24 bg-deep-ocean text-white overflow-hidden">
          <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="w-full lg:w-1/2 space-y-8">
                <div className="space-y-3">
                  ...
                  <h2 className="font-serif text-3xl md:text-4xl font-bold tracking-tight">
                    What’s Included in Your Church Pack
                  </h2>
                  <p className="text-sm text-white/80 leading-relaxed max-w-xl">
                    We provide practical resources to help your church host a meaningful, organized, and mission-focused Shoe Cutting Party.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    ...
                    "Shoe pattern guidance",
                    "Safety and cutting guidelines",
                    "Mission story resources",
                    "Impact videos or shareable media",
                    "Return shipping instructions",
                    "Group activity format",
                    "Prayer or reflection moment suggestions"
                  ].map((item, index) => (
                ...
                <div className="pt-4">
                  <button 
                    onClick={scrollToForm}
                    className="bg-clay text-white font-bold text-xs uppercase tracking-widest px-8 py-4 rounded-xl hover:brightness-110 hover:scale-102 transition-all text-center shadow-lg cursor-pointer"
                  >
                    Request Church Kit Details
                  </button>
                </div>
              </div>

              {/* Display side image collage */}
              <div className="w-full lg:w-1/2 relative">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-4 translate-y-6">
                    <img 
                      className="rounded-2xl border border-white/10 shadow-lg object-cover w-full h-40" 
                      alt="Mission Template outline close-up"
                      src="/src/assets/images/shoe-patterns-table.png"
                    />
                    <img 
                      className="rounded-2xl border border-white/10 shadow-lg object-cover w-full h-40" 
                      alt="Smiling congregation youths"
                  ...
                  <div className="space-y-4">
                    <img 
                      className="rounded-2xl border border-white/10 shadow-lg object-cover w-full h-40" 
                      alt="Church flyer printables"
                      src="/src/assets/images/shoe_party_pack_1783110078134.jpg"
                    />
                    <img 
                      className="rounded-2xl border border-white/10 shadow-lg object-cover w-full h-40" 
                      alt="Ugandan shoemakers crafting shoes"
                      src="/src/assets/images/shoemakers-at-work.jpg"
                    />
                  </div>
                </div>
        ...
        <section className="py-20 md:py-24 bg-parchment">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto space-y-3 mb-16">
              ...
              <h2 className="font-serif text-3xl md:text-4xl text-deep-ocean font-bold tracking-tight">
                Sample Church Party Flow
              </h2>
              <div className="w-12 h-0.5 bg-clay mx-auto mt-2" />
            </div>

            <div className="max-w-4xl mx-auto bg-white border border-deep-ocean/5 rounded-3xl p-8 md:p-12 shadow-sm space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  { title: "Welcome & Prayer", desc: "Open the event in communal prayer, inviting God to bless the hearts and hands of all serving." },
                  { title: "Sole Hope Mission Story", desc: "Show our short HD documentary video to build real connections and empathy with the children in Uganda." },
                  { title: "Shoe Cutting Instructions", desc: "Walk through the easy tracing and cutting steps so that participants feel confident and equipped." },
                  { title: "Cutting Denim Together", desc: "Spend time in fellowship while table groups cut and prepare the pattern parts together." },
                  { title: "Closing Prayer & Next Steps", desc: "Gather around the completed cuts to thank God, bless the boxes, and pray for the children." },
                  { title: "Send Materials Back to Sole Hope", desc: "Pack up all materials securely to ship them back to Uganda via our streamlined return guide." }
                ].map((item, idx) => (
                  <div key={idx} className="flex gap-4 items-start">
                    <div className="w-8 h-8 rounded-full bg-clay/10 text-clay flex items-center justify-center font-bold font-mono text-xs shrink-0 mt-0.5">
                      {idx + 1}
                    </div>
                    <div>
                      <h4 className="font-serif text-sm font-bold text-deep-ocean">{item.title}</h4>
              ...
              <div className="pt-6 border-t border-deep-ocean/5 flex items-start gap-3 bg-[#FAF7F2] p-4 rounded-xl text-xs text-on-surface-variant">
                <Info className="w-4 h-4 text-clay shrink-0 mt-0.5" />
                <p className="leading-relaxed">
                  <strong>Note:</strong> The flow can be adjusted for Sunday gatherings, youth nights, mission events, women’s ministry meetings, or small group gatherings.
                </p>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="relative rounded-3xl overflow-hidden bg-black/95 aspect-video group cursor-pointer shadow-2xl max-w-4xl mx-auto" onClick={onOpenVideo}>
              <img 
                ...
                src="/src/assets/images/problem_reinfestation_feet_1783107783503.jpg"
              />
        ...
        {/* 6. PRICING SECTION */}
        <section id="church-pricing-section" className="py-20 md:py-24 bg-white border-t border-deep-ocean/5">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto space-y-3 mb-16">
              <span className="text-xs font-mono uppercase tracking-widest text-clay font-bold block">
                Church Pricing
            ...
            <div className="max-w-2xl mx-auto bg-parchment/30 border border-deep-ocean/5 rounded-3xl p-8 md:p-12 text-center space-y-6 shadow-sm">
              <h3 className="font-serif text-2xl font-bold text-deep-ocean">
                Church Shoe Cutting Party Pack
              </h3>
              
              <div className="py-6 border-y border-deep-ocean/5 my-4 space-y-2">
                <span className="font-serif text-5xl font-extrabold text-[#1a3a5c] block">
                  $95
                </span>
              ...
              <p className="text-xs text-clay font-medium max-w-lg mx-auto leading-relaxed bg-clay/5 p-4 rounded-xl border border-clay/10">
              ...
              <div className="pt-4">
                <button 
                  onClick={scrollToForm}
                  className="bg-clay text-white font-bold text-xs uppercase tracking-widest px-8 py-4 rounded-xl hover:brightness-110 hover:scale-102 transition-all text-center shadow-md cursor-pointer"
                >
        ...
        {/* 9. FAQ SECTION */}
        <section id="church-faq-section" className="py-20 md:py-24 bg-parchment">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="space-y-4">
              {churchFaqs.map((faq, idx) => {
                ...
                return (
                  <div key={idx} className="bg-white rounded-2xl border border-deep-ocean/5 overflow-hidden transition-all shadow-sm">
                    <button 
                      onClick={() => setFaqActive(isActive ? null : idx)}
                      className="w-full text-left px-6 py-5 focus:outline-none flex justify-between items-center gap-4 cursor-pointer"
                    >
                    ...
                    <AnimatePresence>
                      {isActive && (
                        <motion.div 
                          ...
                          animate={{ opacity: 1, height: "auto" }}
                          exit={{ opacity: 0, height: 0 }}
                          className="px-6 pb-6 pt-1 text-xs text-on-surface-variant leading-relaxed border-t border-deep-ocean/5 font-sans"
                        >
                          {faq.answer}
                        </motion.div>
                      )}
        ...
        <section className="py-20 md:py-24 bg-clay text-white">
          <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
              <button 
                onClick={scrollToForm}
                className="bg-deep-ocean text-white font-sans font-bold text-xs uppercase tracking-widest px-10 py-5 rounded-xl hover:brightness-110 active:scale-95 shadow-xl transition-all outline-none cursor-pointer"
              >
                Plan a Church Party
              </button>
              <button 
                onClick={scrollToFormAndFocusQuestion}
                className="bg-transparent border-2 border-white text-white font-sans font-bold text-xs uppercase tracking-widest px-10 py-5 rounded-xl hover:bg-white hover:text-clay transition-all outline-none cursor-pointer"
              >
                Ask a Question
              </button>
            </div>
      ...
      {/* Church Registration/Inquiry Form Popup Modal */}
      <AnimatePresence>
        {isFormModalOpen && (
