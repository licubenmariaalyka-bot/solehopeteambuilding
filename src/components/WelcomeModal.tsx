    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-6 overflow-y-auto">
      ...
      >
        ...
        >
          ...
          >
            <img 
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuB8AyrbOLBapcAokKspy-mzdGwZV3ZtZ_9RMVKS89pnUN23bzvIVta8QMGVpovQaqRmPxkNtY9sgEa4GlHM3g-zfpe1pTTlIdlGJBzNfe6LcdP66UVMqmonggLYu7uybrX6ybkwj4du-OfwpsaonXf2rNDxx3x8TrEGZ1CAeP98g891KHetlQqfBlI7Y2nskaOa7wJ2WwUSs5W0ui3IapzkslVdMlCdSMDWdtjxjGKyiA0_W2PRku7eP9Nbm082yZDJL7gj_zQ-CvfHKg"
          ...
          >
            <img 
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuAXszf4aBpaZhZ2BHwp-ZhrC6nhYz1_MIeBO0KjiBBS4BVGW4VB1JdwOc-Nn_DhLYBjz8rnsVhxGOq9RJA13bPv-pAeDWhE4q6Am4sb7kn04smo7_lfjaM8ILRgb45VpLQSPGx9M3bb1NbSl88Nzute6HPjISL9MeaMYzlByR92Kl5ajvwUtsGNfnPnTlOoxO0RGMK7tSFhsDW9-oGuMEh8ope6ROEH8v6maYO16loWuJu9neHp0f61ogCoh8TSH6bTJne-qAYkDZTL0Q"
          ...
          <div className="max-w-md flex flex-col items-center gap-2 group/footer cursor-default">
            ...
            <div className="space-y-1">
              <p className="text-xs md:text-sm text-deep-ocean font-serif font-bold tracking-tight transition-colors duration-300 group-hover/footer:text-clay">
                Protective shoes help children and families affected by jiggers in Uganda
              </p>
