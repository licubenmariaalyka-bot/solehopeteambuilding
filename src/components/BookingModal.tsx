          ...
          {isSuccess ? (
            ...
            <div className="space-y-6">
              ...
              <div className="text-center max-w-md mx-auto space-y-2 flex flex-col items-center">
                <img 
                  src="/images/regenerated_image_1782340932866.png" 
                  alt="Sole Hope Logo" 
                ...
                <h2 className="font-serif text-2xl md:text-3xl text-deep-ocean font-extrabold tracking-tight">
                  Purchase Your Shoe Party Experience
                </h2>
                <p className="text-sm text-on-surface-variant">
                  Buy your $95 Shoe Party Experience. Includes digital hosting materials and 2 pairs of protective shoes.
                </p>
                ...
                <div className="flex justify-between items-center pb-3 border-b border-deep-ocean/5">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-on-surface-variant font-medium">Qty: 1 • Digital Access</p>
                    </div>
                  </div>
