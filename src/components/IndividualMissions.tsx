...
const heroBgImg = "/images/shoe_party_pack_vertical.jpg";
const shoePartyPackImg = "/images/shoe_party_pack_1783110078134.jpg";
const gatherSuppliesImg = "/images/denim_supply_pile.png";
const traceCutImg = "/images/shoe_cutting_party_1782508448020.jpg";
const shipMaterialsImg = "/images/ugandan_shoemaker.webp";
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto">
              {[
                { 
                  ...
                  image: "/images/denim_stack.jpg"
                },
                { 
                  name: "Sharp scissors", 
                  image: "/images/scissors_blue.png"
                },
                { 
