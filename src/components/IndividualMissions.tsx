...
const heroBgImg = "/images/family-shoe-party.jpg";
const shoePartyPackImg = "/images/shoe_party_pack_1783110078134.jpg";
const gatherSuppliesImg = "/images/shoe-patterns-table.png";
const traceCutImg = "/images/shoe_cutting_party_1782508448020.jpg";
const shipMaterialsImg = "/images/shoe-cutting-volunteers.webp";
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto">
              {[
                { 
                  ...
                  image: "/images/community-shoe-party.jpg"
                },
                { 
                  name: "Sharp scissors", 
                  icon: <Scissors className="w-4 h-4 text-clay rotate-90" />,
                  image: "/images/team-building-banner.png"
                },
                { 
                ...
                { 
                  ...
                  image: "/images/mission-story-image.jpg"
                }
              ].map((item, index) => (
