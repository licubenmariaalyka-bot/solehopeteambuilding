...
const problemFeetImg = "/images/jigger-treatment-care.jpg";
const solutionShoesImg = "/images/protective-shoes.jpg";
const heroBgImg = "/images/individual-shoe-party-hero.jpg";
const shoePartyPackImg = "/images/shoe-party-experience-pack.jpg";
const gatherSuppliesImg = "/images/gather-supplies.png";
const traceCutImg = "/images/shoe-cutting-party.jpg";
const shipMaterialsImg = "/images/ship-materials.webp";
const holisticCareImg = "/images/individual-path.jpg";
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto">
              {[
                { 
                  ...
                  image: "/images/denim-jeans-supplies.jpg"
                },
                { 
                  name: "Sharp scissors", 
                  image: "/images/cutting-tools-supplies.png"
                },
                { 
                ...
                { 
                  name: "Safety pins", 
                  image: "/images/safety-pins-markers.jpg"
                }
              ].map((item, index) => (
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="relative h-[340px] sm:h-[400px] lg:h-auto min-h-[400px] bg-parchment/50 p-6 md:p-8">
                  ...
                  <div className="absolute top-0 left-0 w-[58%] h-[56%] rounded-2xl overflow-hidden shadow-lg z-10 -rotate-2 border-[5px] border-white">
                    <img
                      src="/images/holistic-care-medical.jpg"
                  ...
                  <div className="absolute top-7 right-0 w-[54%] h-[52%] rounded-2xl overflow-hidden shadow-lg z-20 rotate-1 border-[5px] border-white">
                    <img
                      src="/images/holistic-care-shoes.jpg"
                  ...
                  <div className="absolute bottom-0 left-[10%] w-[58%] h-[54%] rounded-2xl overflow-hidden shadow-lg z-30 rotate-2 border-[5px] border-white">
                    <img
                      src="/images/holistic-care-outreach.jpg"
