        ...
        <section className="relative h-[650px] md:h-[720px] flex items-center overflow-hidden bg-deep-ocean text-white">
          <div className="absolute inset-0 z-0">
            ...
            <img 
              ...
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuA0oYLKY0it2dDbTlb-JNsjiT6P819w5U_gBa3ttw3WS8v3qPGr4-fwXaCNdRBOLTfrEenXTV2Xd9LtSF4oWpIsyxj27W8sF07NXYeLwsrhYIvn3__v8TQub5vWqgd2KYpQgbu1W0Lar_W_j-SfC1FN3Dp_1vL_akt9___wDxajcgPZ5LpoDvn9mz8VB6OVIxc4n1PMN_zaOWDBha5zDGMyVMMHY_5Ire7_pr4eofXW9ZAIBbRZHqKVWc5mVk4gFV4rWO6QXwV6sxVBeA"
            />
          </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="rounded-xl overflow-hidden aspect-square border border-deep-ocean/5 shadow-sm">
                    <img 
                      ...
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuBr7XNWDv7j5uwTlGCaoEc3bqYlESEXcVKeMMORZND3BjCkD-fWYQneIKz7_iy8WhUAdYI2cBwqyKNC2c2bgYCj3vuwME1BXe6TTDEsAdt5fy6aZ1hOvZ754AuSPerTeS2wAudQS7RvUxXhgk7ccZJa-dMjyuqn8u7clAyOn9LeMO7LHO7dFZMp21QLjzre9lz940tOALMKtAucB0BGgrPZdnLPlxWnvOQuVRdEHH8Ba-e8CI4-nRWFA4cjTaLAZTBhcyLNfsOD5oNBvg"
                    />
                  </div>
                  <div className="rounded-xl overflow-hidden aspect-square border border-deep-ocean/5 shadow-sm">
                    <img 
                      ...
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuBvfM0Q4cEDKt3tMPCmNnDVNvodN-JBm_QA_DUeg2ciYy-y9sP0XKuUzY-RltVxX_RKD5NEtSOslGQKlAF6I5IPHO4RErlBkmmGCYDrAXuDpdpYTfrwzc_kebAdguqH-tzusnsUJFGUN7Ysz_GPRKkZMywZ3Yg4ij2nqEo-z9K3DSQsFDyxRi_Qce3QDSzLTOvSmejZ0z_mSbJaKm3DgycarO1jxtOceUArm5Gm-57OZxLHAOBZxWNBXnnFMo23ITJcShBxlPRYoLFq3A"
                    />
                  </div>
                </div>
              </div>
